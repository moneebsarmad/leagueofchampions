      ...
      <div className="px-8 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-base font-semibold text-[var(--navy)]">{adminName}</p>
              <p className="text-sm text-[var(--navy)]/40">Administrator</p>
            </div>
          </div>
          <div className="w-px h-8 bg-[var(--navy)]/10"></div>
          <button
            onClick={handleLogout}
            className="flex items-center gap-2 text-sm text-[var(--navy)]/50 hover:text-[var(--house-aishah)] font-medium transition-colors"
          >
