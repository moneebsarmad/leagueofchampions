...
extension Student {
    static let sampleStudents: [Student] = [
        Student(id: "1", name: "Ahmed Khan", grade: "7", section: "A", house: .abuBakr, gender: "M"),
        Student(id: "2", name: "Fatima Ali", grade: "7", section: "A", house: .khadijah, gender: "F"),
        Student(id: "3", name: "Omar Hassan", grade: "7", section: "B", house: .umar, gender: "M"),
        Student(id: "4", name: "Aisha Rahman", grade: "7", section: "B", house: .aishah, gender: "F"),
        Student(id: "5", name: "Yusuf Ahmad", grade: "8", section: "A", house: .abuBakr, gender: "M"),
        Student(id: "6", name: "Maryam Malik", grade: "8", section: "A", house: .khadijah, gender: "F"),
        Student(id: "7", name: "Ibrahim Qureshi", grade: "8", section: "B", house: .umar, gender: "M"),
        Student(id: "8", name: "Khadijah Hussain", grade: "8", section: "B", house: .aishah, gender: "F"),
        Student(id: "9", name: "Bilal Farooq", grade: "9", section: "A", house: .abuBakr, gender: "M"),
        Student(id: "10", name: "Zainab Siddiqui", grade: "9", section: "A", house: .khadijah, gender: "F"),
        Student(id: "11", name: "Hamza Sheikh", grade: "9", section: "B", house: .umar, gender: "M"),
        Student(id: "12", name: "Sara Iqbal", grade: "9", section: "B", house: .aishah, gender: "F")
    ]
}
